...
class KChartWidget extends StatefulWidget {
  ...
  final bool isLine;
  final Future Function()? loadMoreCallBack;
  late final ChartStyle _chartStyle;
  late final ChartColors _chartColors;
  KChartWidget(this.datas,
    ...
    _chartColors = chartColors ?? ChartColors();
...
class _KChartWidgetState extends State<KChartWidget>
    ...
    return GestureDetector(
      ...
      onHorizontalDragUpdate: (details) {
        ...
        mScrollX = (details.primaryDelta! / mScaleX + mScrollX)
            ...
            .toDouble();
        if(mScrollX > ChartPainter.maxScrollX - 300 && isLoad == false){
          isLoad = true;
        ...
        children: <Widget>[
          CustomPaint(
            ...
            painter: ChartPainter(
                ...
                chartStyle: widget._chartStyle,
                chartColors: widget._chartColors),
          ),
          _buildInfoDialog()
        ],
      ),
 ...
 void load()async{
   await widget.loadMoreCallBack?.call();
   isLoad = false;
 }
  void _stopAnimation() {
          ...
          return Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                  color: widget._chartColors.markerBgColor,
                  border: Border.all(
                      color: widget._chartColors.markerBorderColor,
                      width: 0.5)),
              child: Column(
    ...
    return Container(
      ...
      child: Row(
        ...
        children: <Widget>[
          Text("$infoName",
              style: TextStyle(
                  color: Colors.white, fontSize: widget._chartStyle.textSize)),
          SizedBox(width: 5),
          Text(info,
              style: TextStyle(
                  color: color, fontSize: widget._chartStyle.textSize)),
        ],
      ),
    );
  }
