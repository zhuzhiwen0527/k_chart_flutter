...
//    final int gridRows = 4, gridColumns = 4;
    ...
    // }
    // double columnSpace = chartRect.width / (gridColumns-1);
    // for (int i = 1; i < gridColumns; i++) {
    //   double x = columnSpace/2.0;
    //   if(i > 1){
    //     x = columnSpace/2.0 + (i-1)*columnSpace;
    //   }
    //   canvas.drawLine(Offset(x, topPadding / 3),
    //       Offset(x, chartRect.bottom), gridPaint);
    // }
  }
}
