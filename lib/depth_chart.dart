...
class DepthChart extends StatefulWidget {
  ...
  DepthChart(this.bids, this.asks,{ChartColors? chartColors}):_chartColors = chartColors ?? ChartColors();
    ...
    return GestureDetector(
      ...
      child: CustomPaint(
        ...
        painter: DepthChartPainter(
            widget.bids, widget.asks, pressOffset, isLongPress,widget._chartColors),
      ),
    );
  }
}
...
class DepthChartPainter extends CustomPainter {
  ...
  final Paint selectPaint , selectBorderPaint;
  DepthChartPainter(
      this.mBuyData, this.mSellData, this.pressOffset, this.isLongPress,this.chartColors)
      : mBuyLinePaint = Paint()
          ..isAntiAlias = true
